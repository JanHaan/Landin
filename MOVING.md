...
| 31 of 36 checks in `check.py` have no control proving they can fail. | — | the check.py audit, whose first step this is: a property cannot be shown to have moved home if neither holder can be made to fail |
