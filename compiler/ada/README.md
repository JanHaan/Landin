...
builds its selected-target field and variant layout. Symbolic declaration
validation rejects invalid free names, decidable fixed-formal/result or field
shapes, duplicate labels, unconditional expansion cycles and impossible
by-value nominal recursion in an unused template. Concrete instances use the
