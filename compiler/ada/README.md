...
| `Landin.Backend.X86_64` | the assembly text for one target, every register in it, and the target-width directives and padding for written aggregate images | decide a layout, write a file, or run a tool |
