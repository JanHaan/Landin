...
| `Landin.Stages.Checking` | the three type passes, compile-time-only positional substitution and scalar/fixed-array normalization of parameterized aliases, and checking-stage diagnostic order | own a table, a code, or a width |
