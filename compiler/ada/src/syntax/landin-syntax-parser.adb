      ...
      return Result : Tree do
         declare
            ...
            begin
               ...
               --  D138 is deliberately module-declaration syntax.  `fixed`
                     ...
                     Complain
                       (Item    => Syn.Token_Expected,
                        ...
                        Message => "`public` cannot modify a fixed"
                                   & " conditional",
                        Note    => "D138: a fixed conditional selects module"
            ...
            --  D138: a fixed conditional is a declaration-list splice, not
                  ...
                  declare
                     Ignored : constant Boolean := Expect
                       (Wanted  => Tok.Kw_If,
                        ...
                        Note    => "D138: fixed if expression then"
                                   & " declaration* end if",
                        Related => At_Fixed,
                        Because => "this `fixed`");
                  begin
                           ...
                           then
                              ...
                              Complain
                                (Item    => Syn.Stray_Token,
                                 ...
                                 Note    => "D138: an arm contains only"
                                            & " module declarations");
                              Advance;
                           end if;
                           if Index = Before then
               ...
               if Peek = Tok.Kw_End and then Ahead (1) = Tok.Kw_If then
                  ...
                  Complain
                    (Item    => Syn.Unclosed_Construct,
                     ...
                     Note    => "D138: a fixed conditional closes with `end`"
                                & " `if`",
                     Related => At_Fixed,
                     Because => "opened here",
                     Gate    => False);
