...
| every push and pull request | `.github/workflows/gate.yml` | the documents, the complete corpus on Linux x86-64 in debug mode, and the scaling benchmark with the release compiler |
