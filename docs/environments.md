...
only inside a test; the GitHub gate does not.
...
ZAZPRO. It installs the same archives the container recipe and the GitHub
workflows install, verified against the same checksums, because it reads
